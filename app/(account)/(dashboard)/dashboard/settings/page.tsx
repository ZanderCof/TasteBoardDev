...
export default function SettingsPage() {
  ...
  return (
    <div className="max-w-[1200px] mx-auto space-y-10">
      <header>
        <h1 className="text-4xl font-black text-slate-900 tracking-tight">Impostazioni</h1>
        <p className="text-slate-500 font-medium mt-1 text-lg">Gestisci il cuore pulsante del tuo locale.</p>
      </header>
      ...
      <div className="grid lg:grid-cols-[300px_1fr] gap-10 items-start">
        ...
        <motion.div 
          ...
          className="bg-white/60 backdrop-blur-xl rounded-[3rem] p-8 md:p-12 border border-white shadow-2xl shadow-slate-200/40"
        >
