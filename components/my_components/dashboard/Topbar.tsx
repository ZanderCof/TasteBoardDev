      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-3 cursor-pointer">
          <div className="text-right hidden sm:block">
            <p className="text-sm font-bold text-slate-900 leading-none">Ristorante Da Mario</p>
            <p className="text-[10px] font-bold text-brand-red uppercase mt-1">Admin Account</p>
          </div>
          <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-brand-red to-orange-400 flex items-center justify-center text-white font-bold shadow-md">
            M
          </div>
        </div>
      </div>
