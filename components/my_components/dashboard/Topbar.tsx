    ...
    <header className="sticky z-40 h-22 bg-white/60 backdrop-blur-xl border border-white/80 rounded-[2.5rem] px-6 flex items-center justify-between shadow-[0_8px_30px_rgb(0,0,0,0.04)] transition-all">
      ...
      <div className="relative w-full max-w-md group">
        ...
        <input
          ...
          className="w-full bg-slate-100/50 border border-transparent rounded-[1.2rem] py-3 pl-12 pr-12 outline-none focus:bg-white focus:border-red-500/20 focus:ring-4 ring-red-500/5 transition-all font-bold text-sm placeholder:text-slate-400 placeholder:font-medium"
        />
        {/* Shortcut visivo */}
      ...
      <div className="flex items-center gap-2">
        ...
        <button className="relative p-3 bg-white rounded-2xl border border-slate-100 text-slate-500 hover:text-red-600 hover:border-red-100 hover:shadow-md transition-all group">
          <Bell size={20} strokeWidth={2.5} />
          <span className="absolute top-2.5 right-2.5 w-2.5 h-2.5 bg-red-500 border-2 border-white rounded-full animate-bounce" />
        </button>
